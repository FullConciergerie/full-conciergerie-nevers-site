/**
 * Bouton WhatsApp flottant en bas à droite de chaque page — design v2.
 *
 * - Numéro : +33 6 61 75 37 38 (mobile pro)
 * - Message pré-rempli avec mention du site
 * - Server component (juste un <a>, aucune logique JS)
 *
 * Design : pill verte WhatsApp officielle, bordure dorée fine, double
 * anneau de pulse subtil, label hover qui révèle une accroche, icône
 * SVG officielle. Mobile : bulle ronde compacte.
 */
  ...
  return (
    ...
    >
      ...
      <span className="wa-bubble">
        ...
        {/* Dot de présence en ligne */}
        <span className="wa-online-dot" aria-hidden="true" />
      </span>

      {/* Label texte : visible desktop seulement */}
      <span className="wa-text">
        <span className="wa-eyebrow">Réponse rapide</span>
